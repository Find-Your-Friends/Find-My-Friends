...
//         },
//         theLittleThings: { expectation, aSecret, iceBreaker },
//       } = formData;
...
//         frequency_of_socialising: frequencyOfSocialising,
//         personality_type: personalityType,
//         gender_preference: eventGenderPreference,
//         ice_breaker_question: iceBreaker,
//         a_secret: aSecret,
//       });
//       setCurrentUser(user)
  ...
  const {
   ...
   async function handleSubmit(event) {
    ...
    if (!isLastStep) {
      ...
      // Deconstruct form data with corrected state key
      const {
        basicInfo: { age, gender, location },
        defaultPreferences: {
          preferredGroupSize,
        ...
        theLittleThings: { expectation, hobbies, aSecret, iceBreaker },
      } = formData;
